...
- **특징**: 
  ...
  - 빠른 리로드
  - 개발 도구 사용 가능
- **API 연결**: `http://100.55.36.73:8080/api` (서버 API 직접 사용)
...
```
VITE_API_BASE_URL=http://100.55.36.73:8080/api
...
export const getApiBaseUrl = (): string => {
  ...
  if (hostname === 'localhost' || hostname === '127.0.0.1') {
    return 'http://100.55.36.73:8080/api';
  }
  return '/api';
};
```
...
- **로컬**: `http://100.55.36.73:8080/api` 사용
- **서버**: `/api` 사용 (Nginx 프록시)

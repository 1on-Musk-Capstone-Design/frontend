...
API 서버(43.201.225.38:8080)와 같은 서버에 프론트엔드를 배포하는 방법입니다.
...
# 서버에 업로드 (로컬 터미널에서 실행)
scp -i capstone.pem -r dist/* ec2-user@43.201.225.38:/var/www/onit/
...
server {
    listen 80;
    server_name 43.201.225.38;  # 또는 실제 도메인
    root /var/www/onit;
    index index.html;
...
# 또는 브라우저에서 접속
# 프론트엔드: http://43.201.225.38
# API: http://43.201.225.38/api (Nginx가 자동으로 프록시)
```
